...
INFLUXDB_HOST=${INFLUXDB_PORT_8806_TCP_ADDR:-${INFLUXDB_HOST}}
INFLUXDB_HOST=${INFLUXDB_1_PORT_8806_TCP_ADDR:-${INFLUXDB_HOST}}
INFLUXDB_PORT=${INFLUXDB_PORT_8806_TCP_PORT:-${INFLUXDB_PORT}}
INFLUXDB_PORT=${INFLUXDB_1_PORT_8806_TCP_PORT:-${INFLUXDB_PORT}}
